...
Private Sub cmbItem_Click()
    If cmbItem.ListIndex > 0 And cmbItem.ListIndex <= MAX_ITEMS Then
        If txtItemValue > 0 Then
            cmbCostItem.ListIndex = FindMoneyID
            txtCostValue = txtItemValue * Item(cmbItem.ListIndex).price
        End If
    End If
End Sub
...
Private Sub txtItemValue_Change()
    If cmbItem.ListIndex > 0 And cmbItem.ListIndex <= MAX_ITEMS Then
        If txtItemValue > 0 Then
            txtCostValue = Item(cmbItem.ListIndex).price * txtItemValue
        End If
    End If
End Sub
