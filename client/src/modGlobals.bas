...
'timer de atack
Public TimeSinceAttack As Currency
' chars
...
Public SpellBufferTimer As Currency
...
Public TargetDown As Boolean
Public upDown As Boolean
Public downDown As Boolean
Public leftDown As Boolean
Public rightDown As Boolean

Public SetaUp As Boolean
Public SetaDown As Boolean
Public SetaLeft As Boolean
Public SetaRight As Boolean
...
Public MapEditorLightSize As Long
...
' Pinging
Public PingStart As Currency
Public PingEnd As Currency
Public Ping As Long
' indexing
