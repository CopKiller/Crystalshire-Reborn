...
Private Sub cmdLight_Click()
    ...
    MapEditorLightSize = scrlTamanho.Value
    picAttributes.visible = False
...
Private Sub scrlTamanho_Change()
    Select Case scrlTamanho.Value
    Case 1
        lblTamanho.caption = "32x32"
    Case 2
        lblTamanho.caption = "64x64"
    Case 3
        lblTamanho.caption = "96x96"
    Case 4
        lblTamanho.caption = "128x128"
    Case 5
        lblTamanho.caption = "160x160"
    Case 6
        lblTamanho.caption = "192x192"
    Case 7
        lblTamanho.caption = "224x224"
    Case 8
        lblTamanho.caption = "256x256"
    Case 9
        lblTamanho.caption = "288x288"
    Case 10
        lblTamanho.caption = "320x320"
    End Select
End Sub
...
Private Sub scrlMapItem_Change()
    ...
    If Item(scrlMapItem.Value).Stackable > 0 Then
