...
' Connection details
Public Const GAME_SERVER_IP As String = "localhost"    ' "46.23.70.66"
Public Const AUTH_SERVER_IP As String = "localhost"    ' "46.23.70.66"
...
' Item Path and variables
Public Const ITEM_PATH As String = "\Data Files\items\"
' Npc Path and variables
Public Const NPC_PATH As String = "\Data Files\npcs\"
' Key constants
...
Public Const TILE_TYPE_LIGHT As Byte = 17
' Item constants (adicionar os items equipaveis em uma sequencia, pra ficar automatizado com o equipment.count e não dar problema no sistema de conjuntos!)
...
Public Const ITEM_TYPE_LEGS As Byte = 5
Public Const ITEM_TYPE_BOOTS As Byte = 6
Public Const ITEM_TYPE_AMULET As Byte = 7
Public Const ITEM_TYPE_RINGLEFT As Byte = 8
Public Const ITEM_TYPE_RINGRIGHT As Byte = 9
...
Public Const ITEM_TYPE_UNIQUE As Byte = 14
Public Const ITEM_TYPE_FOOD As Byte = 15
Public Const ITEM_TYPE_PROTECTDROP As Byte = 16
' Direction constants
...
Public Const EDITOR_SERIAL As Byte = 8
Public Const EDITOR_TASKS As Byte = 9
Public Const EDITOR_CONJUNTO As Byte = 10
...
Public Const Path_Panoramas As String = "\data files\graphics\panoramas\"
Public Const Path_Flags As String = "\data files\graphics\flags\"
