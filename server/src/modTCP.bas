...
Sub CheckConnectionTime()
    ...
    For I = 1 To MAX_PLAYERS
        ...
        If IsConnected(I) Then
            ...
            If Not Player(I).TokenAccepted Then

                If GetTickCount >= Player(I).ConnectedTime + MAX_CONNECTED_TIME Then
...
'Obtem o tempo em que o usuario foi conectado.
    Player(Index).ConnectedTime = GetTickCount
...
Sub HackingAttempt(ByVal Index As Long)
    AlertMsg Index, "Ocorreu um erro."
End Sub

Public Sub AlertMsg(ByVal Index As Long, ByVal Msg As String, Optional ByVal menuReset As Long = 0, Optional ByVal kick As Boolean = True)
    Dim Buffer As clsBuffer
    Set Buffer = New clsBuffer
