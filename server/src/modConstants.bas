...
Public Const ITEM_BIND_OBTAINED As Byte = 1
Public Const ITEM_BIND_EQUIPED As Byte = 2
...
Public Const DIALOGUE_LOTTERY_MAXBID As Byte = 22
Public Const DIALOGUE_LOTTERY_MINBID As Byte = 23
Public Const DIALOGUE_LOTTERY_NUMBERS As Byte = 24
Public Const DIALOGUE_LOTTERY_NUMBERALREADY As Byte = 25
Public Const DIALOGUE_LOTTERY_CLOSED As Byte = 26
Public Const DIALOGUE_LOTTERY_GOLD As Byte = 27
Public Const DIALOGUE_LOTTERY_SUCCESS As Byte = 28
